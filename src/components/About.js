 ...
 * Includes bio, photo, and key facts about Joshua.
 */
function About() {
  const facts = [
        ...
        <div className={styles.grid}>
          ...
          <div className={styles.right}>
            ...
            <div className={styles.bio}>
              <p>I'm <strong>Izehiuwa Igiebor Omogiate</strong>, English name <strong>Joshua</strong> — a Nigerian Certified Fullstack Web Developer, currently based in <strong>São Paulo, Brazil</strong>. I'm passionate about building modern, scalable web applications and APIs that solve real human problems.</p>
